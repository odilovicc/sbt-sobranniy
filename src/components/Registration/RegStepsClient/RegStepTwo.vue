<template>
    <div class="w-full lg:w-1/2 mx-0 lg:mx-auto">
        <form action="" class="flex flex-col justify-center gap- items-center" method="post">
            <Message severity="error">Заполните все поля, тщательно смотрев на ответы дабы не ошибаться</Message>
            <div class="w-full">
                <div class="py-5">
                    <label class="block text-900 font-medium mb-2">Прикрепить открытый ключ
                        ЭЦП</label>
                    <FileUpload choose-label="Выбрать" mode="basic" class="w-full mb-3" :maxFileSize="1000000"
                        @upload="onUpload" />
                </div>
                ...
                <div class="px-5 py-2 shadow-xl rounded-xl">
                    <div class="py-5">
                        ...
                        <FileUpload mode="basic" choose-label="Выбрать" class="w-full mb-3" :maxFileSize="1000000" />
